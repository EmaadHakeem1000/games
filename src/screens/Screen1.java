...
public class Screen1 implements Screen, ContactListener{
	MainGame game;
	...
	private ConeLight cLight1, cLight2, cLight3;
	Set<ConeLight> cLset = new HashSet<ConeLight>();
	
	private Player player;
	
	private Texture playerTex, awdTex, touchTheDoorTex;
	...
	public Screen1(MainGame game) {
		...
		cLset.add(cLight1);cLset.add(cLight2);cLset.add(cLight3);
		...
		awdTex = new Texture("adw.png");
		touchTheDoorTex = new Texture("touchTheDoor.png");
	}
	...
	public void render(float delta) {
		...
		batch.draw(awdTex, 100/MainGame.PPM, 230/MainGame.PPM, 100/MainGame.PPM, 100/MainGame.PPM);
		batch.draw(touchTheDoorTex, 1500/MainGame.PPM, 190/MainGame.PPM, 300/MainGame.PPM, 200/MainGame.PPM);
