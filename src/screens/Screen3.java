...
public class Screen3 implements Screen, ContactListener{
...
private SpriteBatch batch;
	...
	public Screen3(MainGame game) {
		...
		cLight2 = new ConeLight(rayHandler, 100, Color.WHITE, 10, 1420/MainGame.PPM, 570/MainGame.PPM, 220, 30);
		cLight3 = new ConeLight(rayHandler, 100, Color.WHITE, 10, 1600/MainGame.PPM, 570/MainGame.PPM, 320, 30);
		cLight4 = new ConeLight(rayHandler, 100, Color.WHITE, 10, 3420/MainGame.PPM, 570/MainGame.PPM, 220, 30);
		cLight5 = new ConeLight(rayHandler, 100, Color.WHITE, 10, 2800/MainGame.PPM, 570/MainGame.PPM, 220, 30);
